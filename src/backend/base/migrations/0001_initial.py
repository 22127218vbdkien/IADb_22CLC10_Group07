# Generated by Django 5.0.8 on 2024-08-27 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anime_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animerelation_set', to='base.anime')),
                ('senior_anime_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='anime_relation', to='base.anime')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='anime',
            name='characters',
            field=models.ManyToManyField(blank=True, through='base.CharacterInAnime', to='base.character'),
        ),
        migrations.CreateModel(
